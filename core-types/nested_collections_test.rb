...
class NestedCollectionsTest < Minitest::Test
  ...
  #   date = Date.today
  #   orders = [
  #     {10944 => {date: (date - 1), products: ['shampoo', 'toothbrush']}},
  #     {10945 => {date: date, products: ['handsoap']}}
  #   ]
    
  #   assert_equal 10944, orders.first.keys
  #   assert_equal date, orders[1][:date]
  #   assert_equal 'shampoo', orders[0][:products][0]
  # end
