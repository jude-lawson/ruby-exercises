...
class ArrayTest < Minitest::Test
  ...
  def test_parallel_assignment
    ...
    *a, b = fruit
    assert_equal %w[apple banana cherry], a
    assert_equal "dewberry", b

    a, b, *c = fruit
    assert_equal "apple", a
    assert_equal "banana", b
    assert_equal %w[cherry dewberry], c

    *a, b, c = fruit
    assert_equal %w[apple banana], a
    assert_equal "cherry", b
    assert_equal "dewberry", c

    a, *b, c = fruit
    assert_equal "apple", a
    assert_equal %w[banana cherry], b
    assert_equal "dewberry", c
  end
  ...
  def test_delete
    ...
    assert_equal %w[bacon chicken bacon bacon steak], protein

    deleted = protein.delete("bacon")
    assert_equal "bacon", deleted
    assert_equal %w[chicken steak], protein
  end
  ...
  def test_delete_at
    ...
    assert_equal %w[carrot courgette], veggies
  end

  def test_compact
    assert_equal %w[a b c], ["a", "b", "c"].compact
    assert_equal %w[a b c], ["a", nil, "b", "c", nil, nil].compact
